...
public class MainActivity extends JFrame{
    ...
    public static void main(String args[]) {  
       ...
       if(file.exists()==false) {
    	...
    	new MainActivity().abcde(new String("2021-06-07 00:00:00"),"距离2021年高考还有",1,"高考");
    	new MainActivity().abcde(new String("2021-01-06 00:00:00"),"距离2021年选考还有",2,"选考");
    ...
    public void controller() {
		...
		JLabel aboutText = new JLabel("<html><body><p>浙江省考试倒计时2021年专用版<br />Version 1.1 with Updated 1<br />Updated 2021-02-28(可选更新)<br />版权所有&copy;XuPeng Studio,2019~2020.<br /><br />许可："+copyright+"<br />罗浮中学专用版 2021</p></body></html>");
    	...
    	if(SystemTray.isSupported()) {
    		...
    		popupMenu.add(item6);
    		popupMenu.add(item);
    		TrayIcon trayicon = new TrayIcon(icon.getImage(),"2021年浙江考试倒计时\n状态正常",popupMenu);
