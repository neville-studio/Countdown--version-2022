...
public class kcbActivity {
	...
	private static void loadfile(){
		...
		doc = builder.parse(file);}catch(Exception error) {
			...
			public void keyTyped(KeyEvent arg0) {
				...
				for(int i = 0;i < jt2.getText().length();i++) {
					if(jt2.getText().substring(i,i+1).equals("-")&&i!=4&&i!=7) {
						...
						if(Integer.parseInt(jt2.getText().substring(0,4))<2019) {
							jt2.setText("2019"+jt2.getText().substring(4));
						}else if(Integer.parseInt(jt2.getText().substring(0,4))>2022) {
							jt2.setText("2022"+jt2.getText().substring(4));
			...
			public void keyTyped(KeyEvent arg0) {
				...
				for(int i = 0;i < setthirdtime.getText().length();i++) {
					if(setthirdtime.getText().substring(i,i+1).equals("-")&&i!=4&&i!=7) {
						...
						if(Integer.parseInt(setthirdtime.getText().substring(0,4))<2019) {
							setthirdtime.setText("2019"+setthirdtime.getText().substring(4));
						}else if(Integer.parseInt(setthirdtime.getText().substring(0,4))>2022) {
							setthirdtime.setText("2022"+setthirdtime.getText().substring(4));
